...
export const contractsDescriptions: { [k: string]: string } = {
    safeEngine:
        'The VaultEngine contract is the core of PARYS Protocol. It is responsible for having the accountance of all opened Vaults.',
    accountingEngine:
        'The AccountingEngine contract is responsible for the accounting of PARYS Protocol. Holds both system surplus and debt, and auctions them off when necessary.',
    taxCollector:
    ...
    globalSettlement: 'The GlobalSettlement contract is responsible for the global settlement of PARYS Protocol.',
    debtAuctionHouse:
    ...
    systemCoin:
        'The System Coin contract is the ERC20 token (PARYS) that is used to mint or burn debts within the system.',
    ...
    protocolToken:
        'The ProtocolToken contract is the ERC20Votes token (AGREE) that is used for Surplus and Debt auctions.',
