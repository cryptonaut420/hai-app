...
const externalContracts = [
    {
        ...
        name: 'Uniswap V3 Pool - PARYS/WETH (0.3%)',
        description: `Uniswap liquidity pool. Incentivized with AGREE and OP rewards (full-range only).`,
    ...
    },
    {
        ...
        name: 'Uniswap V3 Pool - PARYS/WETH (1%)',
    ...
    },
    {
        ...
        name: 'Velodrome Pool - PARYS/sUSD',
        description: `Velodrome liquidity pool. Incentivized with AGREE and OP rewards.`,
    ...
    },
    {
        ...
        name: 'Velodrome Pool - AGREE/OP',
        description: `Velodrome liquidity pool. Incentivized with AGREE rewards.`,
        labelLink: 'View on Velodrome',
